...
RSpec.describe User, type: :model do
  ...
  it "has method #parties_im_hosting that returns all of a user's parties and no others" do
    user1 = User.create!(name: "Twitch", email: "twitch@dogmail.com", password: "password", password_confirmation: "password")
    user2 = User.create!(name: "Clip Clop", email: "clickclack@dogmail.com", password: "password", password_confirmation: "password")
  ...
  it "password digest check" do
    user = User.create!(name: "Meg", email: "meg@mail.com", password: "password", password_confirmation: "password")
